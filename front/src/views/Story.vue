  ...
  methods: {
    ...
    addComicBubbles() {
      window.CharactersBubbles = new window.ComicBubbles("kids-safari", {canvas: {readonly: false}}, {bubble: [
        {id: 'b1', text: `Olá ${localStorage.getItem('name')}!`, x: 150, y: 20, width: 194, height: 69, fontSize: '20px', background: '#fff', color: '#000', bubbleStyle: 'speak', tailLocation: 'e', tailX: 200, tailY: 56.06, visible: false},
        {id: 'b2', text: "Fala do Narrador...", className: 'lion', lineHeight: 1, x: 30, y: 200, width: 'auto', height: 'auto', fontSize: '20px', background: '#6b8e23', color: '#ffffff', bubbleStyle: 'none', tailLocation: 's', tailX: 533, tailY: 177, visible: false}
      ]});
          ...
          Bubble1.setClassName('lioness').delay(1000).setWidth('auto').setHeight('auto').pumpUp(function(){
            Bubble2.delay(1000).fadeIn(function(){
              ...
              this.delay(2000).fadeOut(function(){ 
                Bubble1.delay(1000).setText(`Eu também tenho \n ${localStorage.getItem('age')} anos`).pumpUp(function(){
                  Bubble2.delay(1000).fadeIn(function(){
                    Bubble1.delay(2000).fadeOut();
                      ...
                      Bubble1.delay(1000).setFontSize(25).setText("Diálogo 3...").fadeIn(function(){
                        Bubble2.delay(1000).setText("CRAC!").setFontWeight('bold').setX(483).setY(54).setTailX(531).setTailY(178).setBackground('#ff0000').pumpUp(100,function(){								
                          Bubble2.delay(2000).fadeOut(function(){
                            this.remove();
                            Bubble1.moveTo(100,120,'fast').setText("Diálogo 4...");
                          });
                        });
                      });
                    });
